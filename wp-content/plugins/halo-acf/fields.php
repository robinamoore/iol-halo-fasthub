            ...
            [
                ...
                'layouts'      => [
                    ...
                    [
                        ...
                        'label'      => '01 · Page Hero',
                        'sub_fields' => [
                            [ 'key'=>'field_halo_hero_eyebrow', 'name'=>'eyebrow', 'label'=>'Eyebrow', 'type'=>'text', 'instructions'=>'Small label above the title. e.g. "All-in-one EV charging hub"' ],
                            [ 'key'=>'field_halo_hero_title',   'name'=>'title',   'label'=>'Title',   'type'=>'text', 'required'=>1, 'instructions'=>'Main page heading (becomes H1).' ],
                            [ 'key'=>'field_halo_hero_sub',     'name'=>'sub',     'label'=>'Subtitle','type'=>'textarea', 'rows'=>2 ],
                            [ 'key'=>'field_halo_hero_compact', 'name'=>'compact', 'label'=>'Compact (no image panel)', 'type'=>'true_false', 'ui'=>1, 'instructions'=>'Use for inner pages that don\'t need a hero image.' ],
                            [ 'key'=>'field_halo_hero_cta1_label', 'name'=>'cta1_label', 'label'=>'Primary CTA label', 'type'=>'text', 'placeholder'=>'Make an enquiry' ],
                            [ 'key'=>'field_halo_hero_cta1_url',   'name'=>'cta1_url',   'label'=>'Primary CTA URL',   'type'=>'url' ],
                            [ 'key'=>'field_halo_hero_cta2_label', 'name'=>'cta2_label', 'label'=>'Secondary CTA label', 'type'=>'text' ],
                            [ 'key'=>'field_halo_hero_cta2_url',   'name'=>'cta2_url',   'label'=>'Secondary CTA URL',   'type'=>'url' ],
                            [ 'key'=>'field_halo_hero_image', 'name'=>'image', 'label'=>'Hero image', 'type'=>'image', 'return_format'=>'array', 'preview_size'=>'medium', 'instructions'=>'Right-hand image panel. Ideal: 900×600px.', 'conditional_logic'=>[ [ [ 'field'=>'field_halo_hero_compact','operator'=>'!=value','value'=>'1' ] ] ] ],
                            [ 'key'=>'field_halo_hero_stat1v', 'name'=>'stat1_value', 'label'=>'Stat 1 value', 'type'=>'text', 'placeholder'=>'500+' ],
                            [ 'key'=>'field_halo_hero_stat1l', 'name'=>'stat1_label', 'label'=>'Stat 1 label', 'type'=>'text', 'placeholder'=>'charge points installed' ],
                            [ 'key'=>'field_halo_hero_stat2v', 'name'=>'stat2_value', 'label'=>'Stat 2 value', 'type'=>'text' ],
                            [ 'key'=>'field_halo_hero_stat2l', 'name'=>'stat2_label', 'label'=>'Stat 2 label', 'type'=>'text' ],
                            [ 'key'=>'field_halo_hero_stat3v', 'name'=>'stat3_value', 'label'=>'Stat 3 value', 'type'=>'text' ],
                            [ 'key'=>'field_halo_hero_stat3l', 'name'=>'stat3_label', 'label'=>'Stat 3 label', 'type'=>'text' ],
                        ],
                    ],
                    ...
                    [
                        ...
                        'label'      => '02 · CTA Band',
                        'sub_fields' => [
                            [ 'key'=>'field_halo_cta_title',      'name'=>'title',      'label'=>'Heading', 'type'=>'text', 'required'=>1, 'placeholder'=>'Ready to electrify your site?' ],
                            ...
                            [ 'key'=>'field_halo_cta_btn1_url',   'name'=>'btn1_url',   'label'=>'Button 1 URL',   'type'=>'url' ],
                            [ 'key'=>'field_halo_cta_btn2_label', 'name'=>'btn2_label', 'label'=>'Button 2 label (optional)', 'type'=>'text' ],
                            [ 'key'=>'field_halo_cta_btn2_url',   'name'=>'btn2_url',   'label'=>'Button 2 URL (optional)',   'type'=>'url' ],
                        ],
                    ],
                        ...
                        'sub_fields' => [
                            ...
                            [
                                ...
                                'sub_fields'   => [
                                    ...
                                    [ 'key'=>'field_halo_cl_item_link_url',    'name'=>'link_url',    'label'=>'Link URL',         'type'=>'url' ],
                                ],
                            ],
                        ],
                    ],
                        ...
                        'sub_fields' => [
                            ...
                            [
                                ...
                                'sub_fields'   => [
                                    ...
                                    [ 'key'=>'field_halo_bh_url',      'name'=>'url',      'label'=>'URL',      'type'=>'url',  'required'=>1 ],
                    ...
                    [
                        ...
                        'sub_fields' => [
                            ...
                            [ 'key'=>'field_halo_loc_map_embed',  'name'=>'map_embed',  'label'=>'Google Maps embed URL',  'type'=>'url', 'instructions'=>'The src="" value from Share → Embed a map in Google Maps.' ],
