            ...
            [
                ...
                'layouts'      => [
                    [
                        ...
                        'label'      => 'Story rows',
                        'sub_fields' => [
                            [ 'key'=>'field_cs_sr_eyebrow', 'name'=>'eyebrow', 'label'=>'Eyebrow', 'type'=>'text' ],
                            [ 'key'=>'field_cs_sr_heading', 'name'=>'heading', 'label'=>'Heading', 'type'=>'text' ],
                            [
                                ...
                                'sub_fields'   => [
                                    [ 'key'=>'field_cs_sr_step',  'name'=>'step',  'label'=>'Step', 'type'=>'text' ],
                                    [ 'key'=>'field_cs_sr_title', 'name'=>'title', 'label'=>'Title', 'type'=>'text', 'required'=>1 ],
                                    [ 'key'=>'field_cs_sr_body',  'name'=>'body',  'label'=>'Body',  'type'=>'textarea', 'rows'=>3 ],
                                    [ 'key'=>'field_cs_sr_image', 'name'=>'image', 'label'=>'Image', 'type'=>'image', 'return_format'=>'array', 'preview_size'=>'medium' ],
                                ],
                            ],
                        ],
                    ],
                    [
                        ...
                        'label'      => 'Pull quote',
                        'sub_fields' => [
                            [ 'key'=>'field_cs_pq_quote',       'name'=>'quote',       'label'=>'Quote', 'type'=>'textarea', 'required'=>1, 'rows'=>2 ],
                            [ 'key'=>'field_cs_pq_attribution', 'name'=>'attribution', 'label'=>'Attribution', 'type'=>'text' ],
                        ],
                    ],
                ],
            ],
    ...
    acf_add_local_field_group( [
        ...
        'fields'   => [
            ...
            [
                ...
                'layouts'      => [
                    [
                        'key'        => 'layout_news_article',
                        'name'       => 'article_body',
                        'label'      => 'Article body',
                        'sub_fields' => [
                            [ 'key'=>'field_news_content', 'name'=>'content', 'label'=>'Content', 'type'=>'wysiwyg', 'toolbar'=>'basic', 'media_upload'=>0 ],
                        ],
                    ],
                ],
            ],
